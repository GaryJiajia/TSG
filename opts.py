...
def parse_opt():
    ...
    parser.add_argument('--input_label_h5', type=str, default='data/cocobu_label.h5',
    ...
    parser.add_argument('--ga_index', type=int, default=1,
                        help='when 0, transformer model, when 1, ttransformer')
    parser.add_argument('--vis_ga_index', type=int, default=0,
                        help='when 0, transformer model, when 1, ttransformer')
    parser.add_argument('--hier_add_index', type=int, default=0,
                        help='when 0, do not add neighbor attention, when add them')
    parser.add_argument('--gelu_index', type=int, default=0,
