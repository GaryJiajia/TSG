...
#     print(lang_stats)
#     text_file = open('res_' + opt.id + '.txt', "a")
#     text_file.write('{0}\n'.format(opt.model))
...
loss, split_predictions, lang_stats = eval_utils_tsg.eval_split(model, crit, loader,
        vars(opt))
...
#json.dump(split_predictions, open('vis/'+ 'res_'+opt.id+opt.model[-10:-4] +'.json', 'w'))
